 ...
 * @since 1.0.0
 */
class Katen_Post_Four extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Posts Carousel', 'katen' );
	}
						...
						<div class="inner">
							<?php 
								if ( has_post_thumbnail() ) {
									the_post_thumbnail('katen-thumb-grid-alt');
								} 
							?>
						</div>
					</div>
