 ...
 * @since 1.0.0
 */
class Katen_Post_Twelve extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( '3 Grid Posts', 'katen' );
	}
		...
		<div class="row gy-4 infinite-wrapper">
			...
			?>
				...
				<div class="col-md-6 col-lg-4 post-item">
					<div id="post-<?php the_ID(); ?>" <?php post_class('post post-grid rounded bordered'); ?>>
						<?php if ( has_post_thumbnail() ) : ?>
							<div class="thumb top-rounded">
								...
								<div class="inner">
									<?php 
										echo '<a href="'; the_permalink(); echo '">'; the_post_thumbnail('katen-thumb-grid'); echo '</a>';
									?>
								</div>
							</div>
						<?php endif; ?>
						<div class="details">
							...
							<ul class="meta list-inline mb-0">
								...
								if ( 'yes' === $settings['date'] ) : ?>
									<li class="list-inline-item"><?php the_time('d M Y'); ?></li>
								<?php endif; ?>
							</ul>
