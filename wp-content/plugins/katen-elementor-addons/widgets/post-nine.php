 ...
 * @since 1.0.0
 */
class Katen_Post_Nine extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Posts with Wide Thumb', 'katen' );
	}
	...
	protected function render() {
		...
		<div class="infinite-wrapper">
			...
			?>
				...
				<div id="post-<?php the_ID(); ?>" <?php post_class('post post-xl post-item'); ?>>
					<!-- top section -->
					<div class="post-top">
					...
					<?php if ( has_post_thumbnail() ) : ?>
						...
						<div class="thumb rounded">
							...
							<div class="inner">
								<?php 
									echo '<a href="'; the_permalink(); echo '">'; the_post_thumbnail('katen-thumb-wide'); echo '</a>';
								?>
							</div>
