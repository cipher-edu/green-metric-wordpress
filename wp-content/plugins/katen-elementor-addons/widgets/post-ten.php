 ...
 * @since 1.0.0
 */
class Katen_Post_Ten extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Featured Posts Carousel', 'katen' );
	}
			...
			<div class="post featured-post-md">
                ...
                <a href="<?php the_permalink(); ?>">
                    <div class="thumb rounded">
                        <div class="inner data-bg-image" data-bg-image="<?php echo esc_url( get_the_post_thumbnail_url(get_the_ID(),'katen-thumb-featured-carousel') ) ?>"></div>
                    </div>
                </a>
            </div>
