...
<section class="main-content">
	...
	<div class="container-xl post-container">
		...
		<div class="row gy-4">
			...
			<div class="col-lg-<?php if( get_theme_mod('blog_single_sidebar', true) == true && is_active_sidebar( 'primary-sidebar' ) ) { echo '8'; } else { echo '12'; } ?>">
			...
			<?php if( get_theme_mod('blog_single_sidebar', true) == true && is_active_sidebar( 'primary-sidebar' ) ) { ?>
				<div class="col-md-4">
					<?php get_sidebar(); ?>
				</div>
			<?php } ?>
