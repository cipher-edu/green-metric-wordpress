...
<section class="page-header">
	<div class="container-xl">
		<div class="text-center">
			<h1 class="mt-0 mb-2"><?php single_tag_title(); ?></h1>
	...
	<?php
		echo '<div class="row gy-4">';
			...
			echo '<div class="col-lg-'; if( get_theme_mod( 'blog_sidebar', true ) == true && is_active_sidebar( 'primary-sidebar' ) ) { echo '8'; } else { echo '12'; } echo '">';
				...
				if ( '1' == get_theme_mod( 'tag_layout' ) ) {
					get_template_part( 'template-parts/content-classic' );
				} elseif ( '2' == get_theme_mod( 'tag_layout' ) ) {
					get_template_part( 'template-parts/content-grid' );
				} elseif ( '3' == get_theme_mod( 'tag_layout' ) ) {
					get_template_part( 'template-parts/content-list' );
				} elseif ( '4' == get_theme_mod( 'tag_layout' ) ) {
